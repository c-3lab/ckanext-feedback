...
class FeedbackPlugin(plugins.SingletonPlugin, DefaultTranslation):
    ...
    def get_helpers(self):
        return {
            ...
            'get_resource_issue_resolutions': summary_utilization.get_resource_issue_resolutions,
            'get_package_issue_resolutions': summary_utilization.get_package_issue_resolutions,
        }
